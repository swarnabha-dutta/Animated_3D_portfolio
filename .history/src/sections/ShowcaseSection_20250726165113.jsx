          ...
          <div ref={doctorAppointmentProjectRef} className="first-project-wrapper">
            ...
            <div className="text-content">
              ...
              <p className="text-white-50 md:text-xl mb-4">
                <strong>HealthMate</strong> is a modern healthcare consultation platform focused on transparency, accessibility, and ease of use. Users can explore clear pricing, connect with support, and book consultations seamlessly.
                <br /><br />
              ...
              <div className="flex gap-4 mt-4">
                <a
                  href="https://healthmate-consultation.vercel.app/"
                  target="_blank"
